        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {history.length === 0 ? (
              ...
              history.map((item) => (
                <div key={item.id} className="history-item" onClick={() => loadPastReport(item)} style={{ padding: "1rem", border: "1px solid rgba(255,255,255,0.05)", borderRadius: "8px", cursor: "pointer", transition: "background 0.2s" }}>
          ...
          <div style={{ maxWidth: "720px", margin: "0 auto", position: "relative", zIndex: 1 }}>
            ...
            <div style={{ animation: "fadeUp 0.8s ease 0.15s both" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "1rem" }}>
                <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: "0.65rem", color: "rgba(245,240,232,0.2)", letterSpacing: "0.1em" }}>⌘ + Enter to run</span>
                <button className="deep-btn" onClick={handleSearch} disabled={loading || !query.trim()}
            ...
            {report && !loading && (
              <div style={{ marginTop: "3rem", marginBottom: "5rem", animation: "fadeUp 0.6s ease forwards" }}>
